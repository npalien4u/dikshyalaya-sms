    ...
    public function examResult_Api(Request $request, $user_id, $exam_id, $record_id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $exam_result = DB::table('sm_result_stores')
                ...
                ->where('sm_result_stores.school_id', '=', $record->school_id)
                ->where('sm_result_stores.class_id', '=', $record->class_id)
                ->where('sm_result_stores.section_id', '=', $record->section_id)
                ->where('sm_result_stores.student_id', '=', $student_id)
    ...
    public function saas_examResult_Api(Request $request, $school_id, $user_id, $exam_id, $record_id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $exam_result = DB::table('sm_result_stores')
                ...
                ->where('sm_result_stores.class_id', '=', @$record->class_id)
                ->where('sm_result_stores.section_id', '=', @$record->section_id)
                ->where('sm_result_stores.student_id', '=', @$record->student_id)
                ->select('sm_exams.id', 'sm_exam_types.title as exam_name', 'sm_subjects.subject_name', 'sm_result_stores.total_marks as obtained_marks', 'sm_exams.exam_mark as total_marks', 'sm_result_stores.total_gpa_grade as grade')
